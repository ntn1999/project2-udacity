...
var OrderProductStore = /** @class */ (function () {
    ...
    OrderProductStore.prototype.addProduct = function (quantity, order_id, product_id) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (order.status !== 'active') {
                            throw new Error("Could not add product ".concat(product_id, " to order ").concat(order_id, " because order status is ").concat(order.status));
                        }
                        conn.release();
                        return [3 /*break*/, 4];
                    case 3:
                    ...
                    case 7:
                        err_2 = _a.sent();
                        throw new Error("Could not add product ".concat(product_id, " to order ").concat(order_id, ": ").concat(err_2));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Cannot get order_products ".concat(err_3));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not find order_product ".concat(id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
