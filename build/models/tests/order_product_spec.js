...
describe('OrderProduct Model', function () {
    ...
    it('create method should add a order_product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, store.addProduct(2, '1', '1')];
                case 4:
                    result = _a.sent();
    ...
    it('index method should return a list of order_products', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
